...
{
    @Id //mark id field as our database primary key
    ...
    @Column //attribute is stored in a database ttable column whose name matches
    ...
    //This empty no argument constructor is necessary if we are going to 
